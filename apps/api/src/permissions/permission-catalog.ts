...
export const PERMISSION_MODULES: PermissionModuleDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // فاز ۶۰ (اصلاح — بازخورد کاربر): مدیریت هزینه‌های اضافی/گزینه‌های ترم تحویل/مارک‌آپ
      // («تعیین حاشیه سود») منتقل شد به مرحله «انتخاب نهایی و قیمت‌گذاری» و از کلید موجود
      // selection.set_markup استفاده می‌کنه (نه یک کلید جدید اینجا) — این بخش فقط اصلاح فروش
      // رو نگه می‌داره که با proposal.edit_price موجود گیت شده.
    ],
  },
  {
    module: "outcome",
